...
Функция ДобавитьСтраницу(ТеорияИлиТест, ЭлементСтраницы, ГруппаСтраниц) Экспорт
...
Функция НайтиПоСсылкеНаЭлемент(СсылкаНаЭлемент, Подборка = Неопределено) Экспорт
