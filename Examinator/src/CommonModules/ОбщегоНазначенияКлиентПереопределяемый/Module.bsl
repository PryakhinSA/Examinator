...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	Если НЕ ОбучениеСУО.ПользователюРазрешенВход(ПараметрыРаботыКлиентаПриЗапуске.АвторизованныйПользователь, ПараметрыРаботыКлиентаПриЗапуске.ЭтоПолноправныйПользователь) Тогда
		Параметры.ИнтерактивнаяОбработка = Новый ОписаниеОповещения("ОткрытьОкноЗапретВхода", ЭтотОбъект);
	КонецЕсли;
	
	Если ПараметрыРаботыКлиентаПриЗапуске.ЭтоПолноправныйПользователь Тогда
	
		СписокНеПоддерживаемыхПлатформ = Новый Массив;
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.12.1855");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.12.1924");
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.13.1926");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.13.1865");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.13.1809");		
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1565");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1630");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1694");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1779");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1854");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1944");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1976");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.14.1993");
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1489");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1534");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1565");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1656");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1700");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1747");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1778");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.15.1830");
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1030");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1063");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1125");		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1973");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1814");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1810");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.16.1876");
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.2231");		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.2198");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.2171");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.2127");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.1989");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.1851");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.17.1846");	
		
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.18.1201");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.18.1208");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.18.1289");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.18.1334");
		СписокНеПоддерживаемыхПлатформ.Добавить("8.3.18.1363");						
		
		СистемнаяИнформация = Новый СистемнаяИнформация;
		
		Если СписокНеПоддерживаемыхПлатформ.Найти(СистемнаяИнформация.ВерсияПриложения) <> Неопределено Тогда
			Параметры.ИнтерактивнаяОбработка = Новый ОписаниеОповещения("ОткрытьОкноЗапретаЗапуска", ЭтотОбъект);
		КонецЕсли;

	КонецЕсли;
		
	// Устанавливаем параметры сеанса для электронных ресурсов
	
	ЭлектронныеРесурсыСУЗКлиент.ПередНачаломРаботыСистемы();
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	// Выгружаем общие ресурсы в кэш (в библиотеке не используется)
	
	#Если ВебКлиент Тогда
		
	РезультатВыгрузки = ОбщегоНазначенияСУВызовСервера.ВыгрузитьОбщийРесурсВКэшНаСервере();
	...
	Если ПараметрыРаботыКлиента.ЭлектронныеРесурсы.ИспользоватьОбщийКаталогВТонкомКлиенте Тогда
		...
		ОбщегоНазначенияСУВызовСервера.ВыгрузитьОбщийРесурсВКэшНаСервере();
		
	Иначе
	
		// Выгружаем общие ресурсы в кэш на клиенте.
		
		ОбщегоНазначенияСУКлиентСервер.ВыгрузитьОбщийРесурсВКэш(ПутьКаталогуОбъектов);
		
		// Пытаемся установить готовые электронные ресурсы
		
		Если НЕ ЗначениеЗаполнено(ПараметрыРаботыКлиента.ДатаПервогоЗапуска) Тогда
...
Процедура ОткрытьОкноЗапретВхода(Параметры, ДополнительныеПараметры) Экспорт
	
	Оповещение = Новый ОписаниеОповещения("ОткрытьОкноЗапретВходаЗавершение", ЭтотОбъект, Параметры);
	
	Форма = ОткрытьФорму("РегистрСведений.ВремяДоступаПользователейСУО.Форма.ФормаЗапретВхода",,,,,,Оповещение);
...
Процедура ОткрытьОкноЗапретаЗапуска(Параметры, ДополнительныеПараметры) Экспорт
	
	Оповещение = Новый ОписаниеОповещения("ОткрытьОкноЗапретВходаЗавершение", ЭтотОбъект, Параметры);
	
	Форма = ОткрытьФорму("ОбщаяФорма.ЗапретЗапускаНаВерсияхПлатформыСУ",,,,,,Оповещение);
...
Процедура ОткрытьОкноЗапретВходаЗавершение(Результат, Параметры) Экспорт
