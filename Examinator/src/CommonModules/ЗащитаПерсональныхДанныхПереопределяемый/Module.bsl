...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	НовыеСведения.Объект			= "Справочник.Пользователи";
	НовыеСведения.ПоляРегистрации	= "Ссылка";
	НовыеСведения.ПоляДоступа		= "Наименование";
	НовыеСведения.ОбластьДанных		= "Пользователи";
...
Процедура ЗаполнитьОбластиПерсональныхДанных(ОбластиПерсональныхДанных) Экспорт
	...
	НоваяОбласть.Имя = "Пользователи";
	НоваяОбласть.Представление = НСтр("ru = 'Персональные данные пользователей'");		
...
Процедура ДополнитьДанныеСубъектовПерсональныхДанных(СубъектыПерсональныхДанных, ДатаАктуальности) Экспорт
	...
	Для Каждого СтрокаСубъект Из СубъектыПерсональныхДанных Цикл
		Если ТипЗнч(СтрокаСубъект.Субъект) = Тип("СправочникСсылка.Пользователи") Тогда
