...
Функция ДатаИзмененияМакетов() Экспорт
	...
	Возврат Дата(2019, 03, 01, 17, 38, 00);
...
//
Функция ПутьККаталогуСДаннымиКурсов(Знач ПутьККаталогуЭлектронныхКурсов) Экспорт
...
//
Процедура СкопироватьФайлыВКаталогРесурсов(МассивФайлов, ПутьККаталогу, ЭтоПервыйУровень) Экспорт
