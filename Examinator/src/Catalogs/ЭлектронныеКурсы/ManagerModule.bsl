...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	Если ВидФормы = "ФормаОбъекта" Тогда
		ЭлектронноеОбучение.ОбработкаПолученияФормыОбъектаЭлектронногоКурса(Параметры, ВыбраннаяФорма, СтандартнаяОбработка);
	КонецЕсли;
...
Процедура ПриУстановкеСнятииПометкиУдаленияЭлектронногоКурса(Знач ЭлектронныйКурс, Знач ПометкаУдаления) Экспорт
	...
	Попытка
		...
		РазработкаЭлектронныхКурсовПереопределяемый.ПриУстановкеСнятииПометкиУдаленияЭлектронногоКурса(ЭлектронныйКурс, ПометкаУдаления);
